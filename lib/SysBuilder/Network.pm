...
use FindBin(qw($Bin));
use lib qq($Bin/../lib);
use SysBuilder::Utils qw/backtick run_local fatal_error/;
use SysBuilder::Proc;

=head1 NAME

SysBuilder::Network - Deal with network devices and settings
...
SysBuilder::Proc returns that info in a convenient hash
