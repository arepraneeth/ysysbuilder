...
sub new {
    my $class = shift;
    return bless {
        modules    => SysBuilder::Modules->new,
        hostconfig => undef,
        network    => SysBuilder::Network->new,
        base       => undef,
        steps      => [
            qw (
                init
...
sub run {
    ...
    local $SysBuilder::Utils::VERBOSE = 0;
    run_steps($self);
}
...
sub banner {
 ...
 \__ \ || (_-< _ \ || | | / _` / -_) '_|
 |___/\_, /__/___/\_,_|_|_\__,_\___|_|
                                 |__/
...
FIG2
   ...
   ____         ___       _ __   __
  / __/_ _____ / _ )__ __(_) /__/ /__ ____
 _\ \/ // (_-</ _  / // / / / _  / -_) __/
/___/\_, /___/____/\_,_/_/_/\_,_/\__/_/
                               /___/
...
sub run_installer {
    ...
    unless ( -e "/tmp/sysbuilder-installer-ok" ) {
