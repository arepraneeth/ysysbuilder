package Yahoo::SysBuilder::BootLoader;
...
use Yahoo::SysBuilder::Console qw();
...
sub devices {
    ...
    my $contents    = "# this device map was generated by Yahoo! sysbuilder\n"
        . "(hd0)  $boot_device\n";
...
sub console {
    my $self    = shift;
    my $console = Yahoo::SysBuilder::Console->new;
...
sub grub_conf {
    ...
    my @config;
    push @config, <<'EOT';
# grub.conf generated by Yahoo! SysBuilder
#
